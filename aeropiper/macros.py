...
# File logging is written to /tmp/aeropiper_{time}_{pid}.log by default
FILE_LOGGING_LEVEL = None

# Override with macros from macros_private.py file, if it exists
try:
    from aeropiper.macros_private import *
except ImportError:
    import aeropiper
    ...
    ROBOSUITE_DEFAULT_LOGGER.warning(
        "To setup, create `aeropiper/macros_private.py` (optional) to override settings in macros.py."
    )
