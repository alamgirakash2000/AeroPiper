...
from aeropiper.models.objects import BoxObject, CompositeBodyObject, CylinderObject
from aeropiper.utils.mjcf_utils import BLUE, RED, CustomMaterial, array_to_string
