...
from aeropiper.models.objects import CompositeObject
from aeropiper.utils.mjcf_utils import BLUE, GREEN, RED, CustomMaterial, add_to_dict
...
class HookFrame(CompositeObject):
    ...
    def _get_geom_attrs(self):
        ...
        if self.tip_size is not None:
            from aeropiper.models.objects import ConeObject
